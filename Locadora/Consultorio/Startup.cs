...
namespace Locadora
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //Conexão de contexto com nosso DB via classe de serviços
            ...
            services.AddTransient<IAluguelService, AluguelSqlService>();
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                endpoints.MapControllerRoute(
                    name: "default",
                    pattern: "{controller=Home}/{action=Locadora}/{id?}"); //Alteração da página inicial
